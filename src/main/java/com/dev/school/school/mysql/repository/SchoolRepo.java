...
public interface SchoolRepo extends CrudRepository<SchoolEntity, String> {
	...
	@Query(value = "SELECT id FROM DB.school WHERE name LIKE ?1 LIMIT ?2 OFFSET ?3", nativeQuery = true)
	public List<String> findByNameSubstr(String name, int limit, int offset);
